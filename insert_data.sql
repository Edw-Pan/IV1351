...
('P1', 2025, 200, (SELECT course_layout_id FROM course_layout WHERE course_code='IV1351')),
('P1', 2025, 120, (SELECT course_layout_id FROM course_layout WHERE course_code='IX1500')),
('P1', 2025, 280, (SELECT course_layout_id FROM course_layout WHERE course_code='IV1000')),
('P2', 2025, 50, (SELECT course_layout_id FROM course_layout WHERE course_code='IV2000')),
('P2', 2025, 80, (SELECT course_layout_id FROM course_layout WHERE course_code='IV3000'));

-- 7. PLANNED ACTIVITIES (2025)
-- IV1351 (P1)
INSERT INTO planned_activity (planned_hours, course_instance_id, teaching_activity_id) VALUES 
(20, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
(60, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lab')),
(10, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Seminar')),
(50, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Admin')),
(40, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Exam'));

-- IX1500 (P1)
INSERT INTO planned_activity (planned_hours, course_instance_id, teaching_activity_id) VALUES 
(30, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IX1500' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
(30, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IX1500' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Tutorial'));

-- IV1000 (P1)
INSERT INTO planned_activity (planned_hours, course_instance_id, teaching_activity_id) VALUES 
(40, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1000' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
(100, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1000' AND study_period='P1' AND study_year=2025), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lab'));
...
-- Bob on IV1351 (Labs)
INSERT INTO work_allocation (planned_activity_id, employee_id, allocated_hours) VALUES 
((SELECT planned_activity_id FROM planned_activity JOIN course_instance USING(course_instance_id) JOIN course_layout USING(course_layout_id) JOIN teaching_activity USING(teaching_activity_id) WHERE course_code='IV1351' AND activity_name='Lab' AND study_year=2025), (SELECT employee_id FROM employee JOIN person USING(person_id) WHERE first_name='Bob'), 60);

-- Alice on IV1351 (Admin & Exam)
INSERT INTO work_allocation (planned_activity_id, employee_id, allocated_hours) VALUES 
((SELECT planned_activity_id FROM planned_activity JOIN course_instance USING(course_instance_id) JOIN course_layout USING(course_layout_id) JOIN teaching_activity USING(teaching_activity_id) WHERE course_code='IV1351' AND activity_name='Admin' AND study_year=2025), (SELECT employee_id FROM employee JOIN person USING(person_id) WHERE first_name='Alice'), 50),
((SELECT planned_activity_id FROM planned_activity JOIN course_instance USING(course_instance_id) JOIN course_layout USING(course_layout_id) JOIN teaching_activity USING(teaching_activity_id) WHERE course_code='IV1351' AND activity_name='Exam' AND study_year=2025), (SELECT employee_id FROM employee JOIN person USING(person_id) WHERE first_name='Alice'), 40);

-- (2024)
INSERT INTO course_instance (study_period, study_year, num_students, course_layout_id) VALUES 
('P1', 2024, 180, (SELECT course_layout_id FROM course_layout WHERE course_code='IV1351'));

--(2024)
INSERT INTO planned_activity (planned_hours, course_instance_id, teaching_activity_id) VALUES 
(20, (SELECT course_instance_id FROM course_instance JOIN course_layout USING(course_layout_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2024), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture'));

-- (2024)
INSERT INTO work_allocation (planned_activity_id, employee_id, allocated_hours) VALUES 
((SELECT planned_activity_id FROM planned_activity JOIN course_instance USING(course_instance_id) JOIN course_layout USING(course_layout_id) JOIN teaching_activity USING(teaching_activity_id) WHERE course_code='IV1351' AND study_period='P1' AND study_year=2024 AND activity_name='Lecture'), (SELECT employee_id FROM employee JOIN person USING(person_id) WHERE first_name='Charlie'), 20);