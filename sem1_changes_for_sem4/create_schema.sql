...
CREATE TABLE study_period (
    ...
    period_name VARCHAR(10) NOT NULL UNIQUE
);
...
CREATE TABLE course_instance (
    ...
    CONSTRAINT fk_ci_period FOREIGN KEY (study_period_id) REFERENCES study_period(study_period_id)
);
...
CREATE TABLE work_allocation (
    ...
    employee_id INT NOT NULL,
    allocated_hours NUMERIC(5,1) NOT NULL DEFAULT 0,
